...
[![Codecov test coverage](https://codecov.io/gh/etam4260/crayons/branch/main/graph/badge.svg)](https://codecov.io/gh/etam4260/crayons?branch=main)
...
Get your favorite crayons ready for all your experimental coloring needs in R.
...
**Drag and drop colors to the interactive text canvas.**
**Press the add buttons to copy the color to the clipboard and the screen.**

**BE CAREFUL AS THESE OPERATIONS WILL OVERWRITE YOUR CURRENT COMPUTER CLIPBOARD CONTENT**
CTRL+C

**Made a coloring mistake? Just use the eraser to remove content from the interactive and current clipboard**
Press it to erase the last item.
